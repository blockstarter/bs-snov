...
(function(){
  var express, bodyParser, expressStaticCache, blockstarterWl, ddos, config, map, app, __path, protection, createRoute;
  express = require('express');
  bodyParser = require('body-parser');
  expressStaticCache = require('express-static-cache');
  ...
  if (config.server.useStatic) {
    app.use(expressStaticCache(__path, config.server['static']));
  } else {
